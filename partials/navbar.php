    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="index.php">
                <img src="images/sultra.png" alt="logo" /> 
                <!-- <span class="fw-bold " style="font-family: montserrat,sans-serif;"> <!-- <span class="fs-2 font-effect-shadow-multiple" > BAPPEDA</span> <span class="text-primary fs-5 font-effect-shadow-multiple">Provinsi sulawesi tenggara</span> </span> -->
            </a>
