                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-center py-5 px-4 px-sm-5">
                            <div class="brand-logo">
                                <img src="images/sultra.png" alt="logo"> </div>
                            <div>
                                <span class="fw-bold " style="font-family: Montserrat,sans-serif;"> <span
                                        class="fs-1 ">BAPPEDA</span><br> <span
                                        class="text-primary fs-4">Provinsi Sulawesi Tenggara</span> </span>
                            </div>
                            <br>
                            <!--<h4>Hello! let's get started</h4> -->
                            <h6 class="fw-light">Document Management System</h6> 
                            <br>
                          ...
                          ?>
                                ...
                                <div class="my-2 d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="#" class="auth-conn text-black">Lupa Sandi?</a>
                                </div>
                                <!--<div class="mb-2">
                                ...
                                <div class="text-center mt-4 fw-light">
                                    Tidak mempunyai akun? <a href="register.php" class="text-primary">Buat</a>
                                </div>
                            </form>
                        </div>
                    </div>
