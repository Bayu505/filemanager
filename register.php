                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                           ...
                           <!-- <h4>Hello! let's get started</h4> -->
                            <h6 class="fw-light">Daftar untuk lanjutkan</h6>
                            <form class="pt-3" autocomplete="off"
                                ...
                                <div class="form-group">
                                    ...
                                    <small class="text-secondary">PIN untuk mengkunci dan membuka dokumen</small>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="text-center mt-4 fw-light">
                                    Sudah mempunyai akun ? <a href="index.php" class="text-primary">Masuk</a>
                                </div>
                            </form>
                        </div>
                    </div>
